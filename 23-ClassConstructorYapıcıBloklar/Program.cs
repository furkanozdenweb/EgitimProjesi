...
namespace _23_ClassConstructorYapıcıBloklar
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //MusteriIslemleriTekrarla musteriIslemleriTekrarla = new MusteriIslemleriTekrarla(14); // '()' default olarak constructor yapı bloğu methodu otomatik olarak çalışır ve bir değer göndermezsek hata verir. Çünkü zorunlu olarak constructor yapı methodunda bizi bunu talep etik
    ...
    class MusteriIslemleriTekrarla
    {
        ...
        public MusteriIslemleriTekrarla()  // Yapı bloğunda (constructor ların aşırı yüklenmesi ile) tekrar tanımlarsak ve bir değer istemez isek artık bu class newlendiğinde boşta gönderilebilir. Fakat unutmamalıyız ki _sayi değişkenini kullandığımız methodlar olduğu için tanımlamada defaul bir değer vermeliyiz.
        {
